# dettrace - Dynamic determinism enforcement
...
dettrace can be built from [source](https://github.com/bmwiedemann/dettrace.git). Kernel 4.8+ is recommended, details on how to build can be found at project's [README](https://github.com/bmwiedeman/dettrace/blob/master/README.md).
